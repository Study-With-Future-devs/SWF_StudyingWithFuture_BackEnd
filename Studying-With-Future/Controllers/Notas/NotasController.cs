...
namespace Studying_With_Future.Controllers
{
    ...
    public class NotasController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<NotaResponseDTO>>> GetNotasPorAluno(int alunoId)
        {
            ...
            if (userRole == "Professor")
            {
                var alunoNaTurmaDoProfessor = await _context.Alunos
                    .Include(a => a.Turmas)
                    .AnyAsync(a => a.Id == alunoId &&
                                  a.Turmas.Any(t => t.ProfessorId == userId));
        ...
        public async Task<ActionResult<NotaResponseDTO>> LancarNota(LancarNotaDTO lancarNotaDTO)
        {
            ...
            var alunoMatriculado = await _context.Alunos
                .Include(a => a.Turmas)
                .AnyAsync(a => a.Id == lancarNotaDTO.AlunoId &&
                              a.Turmas.Any(t => t.Id == atividade.TurmaId));
